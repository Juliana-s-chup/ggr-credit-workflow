...
Write-Host ""
Write-Host "📄 Mise à jour des templates HTML..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "📁 Renommage du dossier templates..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "🔄 Mise à jour des références internes..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "🗄️ Création des nouvelles migrations..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "⚠️ Erreur lors de la création des migrations" -ForegroundColor Red
}
