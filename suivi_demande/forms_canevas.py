...
class CanevasPropositionForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'nom_exploitant': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'YOBA'}),
            'matricule_exploitant': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '101'}),
            'date_proposition': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            
            # SECTION 1: IDENTITÉ
            'nom_prenom': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Nom complet'}),
            'date_naissance': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'nationalite': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'CONGOLAISE'}),
            'adresse_exacte': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Quartier, Avenue, N°'}),
            'numero_telephone': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '+242 XX XXX XX XX'}),
            
            # EMPLOI
            'radical': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Radical compte'}),
            'date_ouverture_compte': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'date_domiciliation_salaire': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'emploi_occupe': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Poste occupé'}),
            'statut_emploi': forms.Select(attrs={'class': 'form-select'}),
            'anciennete_emploi': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ex: 16 ans et 06 mois'}),
            'type_contrat': forms.Select(attrs={'class': 'form-select'}),
            
            # EMPLOYEUR
            'nom_employeur': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Nom de l\'employeur'}),
            'lieu_emploi': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Lieu de travail'}),
            'employeur_client_banque': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'radical_employeur': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Radical employeur'}),
            
            # SITUATION FAMILIALE
            'situation_famille': forms.Select(attrs={'class': 'form-select'}),
            'nombre_personnes_charge': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
            'regime_matrimonial': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Si marié(e)'}),
            'participation_enquetes': forms.TextInput(attrs={'class': 'form-control'}),
            
            # LOGEMENT
            'salaire_conjoint': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'emploi_conjoint': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Emploi du conjoint'}),
            'statut_logement': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Propriétaire/Locataire'}),
            'numero_tf': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'N° TF si propriétaire'}),
            
            # PRÊT EN COURS
            'nature_pret_cours': forms.Select(attrs={'class': 'form-select'}),
            'montant_origine_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'date_derniere_echeance': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'montant_echeance_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'k_restant_du_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            
            # SECTION 2: CAPACITÉ D'ENDETTEMENT
            'salaire_net_moyen_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'echeances_prets_relevees': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'total_echeances_credits_cours': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'salaire_net_avant_endettement_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'readonly': 'readonly'}),
            'capacite_endettement_brute_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'readonly': 'readonly'}),
            'capacite_endettement_nette_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'readonly': 'readonly'}),
            
            # SECTION 3: DÉTAILS DU CRÉDIT
            'nature_pret': forms.Select(attrs={'class': 'form-select'}),
            'motif_credit': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Motif du crédit'}),
            
            # Demande client
            'demande_montant_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'demande_duree_mois': forms.NumberInput(attrs={'class': 'form-control', 'min': '1'}),
            'demande_taux_pourcent': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'demande_periodicite': forms.Select(attrs={'class': 'form-select'}),
            'demande_montant_echeance_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'readonly': 'readonly'}),
            'demande_date_1ere_echeance': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            
            # Proposition
            'proposition_montant_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'proposition_duree_mois': forms.NumberInput(attrs={'class': 'form-control', 'min': '1'}),
            'proposition_taux_pourcent': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'min': '0'}),
            'proposition_periodicite': forms.Select(attrs={'class': 'form-select'}),
            'proposition_montant_echeance_fcfa': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.01', 'readonly': 'readonly'}),
            'proposition_date_1ere_echeance': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            ...
            'doc_attestation_employeur_ok': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'doc_attestation_domiciliation_ok': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'doc_assurance_deces_invalidite_ok': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
