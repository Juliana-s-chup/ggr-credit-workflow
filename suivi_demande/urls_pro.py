...
urlpatterns = [
    ...
    path('utilisateur/<int:user_id>/toggle-status/', views_admin.admin_toggle_user_status, name='admin_toggle_status'),
    path('utilisateur/<int:user_id>/change-role/', views_admin.admin_change_user_role, name='admin_change_role'),
    path('utilisateur/<int:user_id>/modifier/', views_admin.admin_edit_user, name='admin_edit_user'),
    ...
    path('gestionnaire/nouveau-dossier/', views.create_application, name='gestionnaire_create_dossier'),
]
