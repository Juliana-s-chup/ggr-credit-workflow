...
urlpatterns = [
    ...
    path("dossier/<int:pk>/transmettre-analyste/", views.transmettre_analyste_page, name="transmettre_analyste_page"),
    ...
    path("dossier/<int:dossier_id>/canevas/", views_canevas.canevas_create_or_edit, name="canevas_form"),
    path("dossier/<int:dossier_id>/canevas/pdf/", views_canevas.canevas_view_pdf, name="canevas_pdf"),
    # Upload documents
    path("dossier/<int:dossier_id>/documents/", views_documents.upload_documents, name="upload_documents"),
    path("dossier/<int:dossier_id>/documents/upload/", views_documents.upload_document_ajax, name="upload_document_ajax"),
    path("dossier/<int:dossier_id>/documents/<int:piece_id>/delete/", views_documents.delete_document_ajax, name="delete_document_ajax"),
    ...
    path("autorisation-ponctuelle/", views_autorisation.autorisation_ponctuelle, name="autorisation_ponctuelle"),
    # Auth flows Option A
    ...
    path("suivi-admin/users/<int:user_id>/activate/", views.admin_activate_user, name="admin_activate_user"),
