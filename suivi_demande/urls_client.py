...
Fonctionnalités limitées aux besoins client
"""
...
urlpatterns = [
    ...
    # Documents (téléchargement uniquement, pas d'upload direct)
    path('dossier/<int:dossier_id>/documents/', views_portals.view_documents, name='view_documents'),
